	...
	<div class="wrapper">
		...
		<div align="left" class="form-group">
			...
			<table class="table table-borderless" style="width:60%">
				<tr><td colspan="4"><br><h4>Enter the student's Thesis Grade</h4><br></td></tr>
				<tr>
					<td>
				...
				<tr>
					<td><label>Thesis Title:</label></td>
					<td><input type="text" name="lesson_name" placeholder="Thesis Title" class="form-control" /></td>
				</tr>
				<tr>
					<td><label>Thesis Grade:</label></td>
